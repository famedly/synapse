...
https://famedly.github.io/synapse/latest/setup/installation.html.
...
By default the config will use SQLite. See the [docs on using Postgres](https://github.com/famedly/synapse/blob/master/docs/postgres.md) for more info on how to use Postgres. Until this section is improved [this issue](https://github.com/element-hq/synapse/issues/8304) may provide useful information.
...
https://github.com/famedly/synapse/blob/master/docs/reverse_proxy.md.

For more information on enabling TLS support in synapse itself, see
https://famedly.github.io/synapse/latest/setup/installation.html#tls-certificates. Of
...
[Admin FAQ](https://famedly.github.io/synapse/latest/usage/administration/admin_faq.html#help-synapse-is-slow-and-eats-all-my-ramcpu).
