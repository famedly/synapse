...
class StatsRoomTests(unittest.HomeserverTestCase):
    ...
    def test_create_room(self) -> None:
        ...
        self.assertEqual(REGISTRY.get_sample_value("synapse_known_rooms_total"), 2)
        self.assertEqual(
            REGISTRY.get_sample_value("synapse_locally_joined_rooms_total"), 2
        )
    ...
    def test_room_metrics(self) -> None:
        ...
        self.assertEqual(
            REGISTRY.get_sample_value("synapse_locally_joined_rooms_total"), 1
        )
        self.assertEqual(REGISTRY.get_sample_value("synapse_known_rooms_total"), 2)
