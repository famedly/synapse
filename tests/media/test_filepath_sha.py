...
class MediaFilePathsTestCase(unittest.TestCase):
    ...
    def test_local_media_filepath(self) -> None:
        ...
        self.assertEqual(
            self.filepaths.local_media_filepath_sha_rel("GerZNDnDZVjsOtardLuwfIBg"),
            "Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )
        self.assertEqual(
            self.filepaths.local_media_filepath_sha("GerZNDnDZVjsOtardLuwfIBg"),
            "/media_store/Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )

    def test_local_media_thumbnail(self) -> None:
        """Test local media thumbnail paths"""
        self.assertEqual(
            self.filepaths.local_media_thumbnail_sha_rel(
                "GerZNDnDZVjsOtardLuwfIBg", 800, 600, "image/jpeg", "scale"
            ),
            "thumbnails/Ge/rZ/NDnDZVjsOtardLuwfIBg/800-600-image-jpeg-scale",
        )
        self.assertEqual(
            self.filepaths.local_media_thumbnail_sha(
                "GerZNDnDZVjsOtardLuwfIBg", 800, 600, "image/jpeg", "scale"
            ),
            "/media_store/thumbnails/Ge/rZ/NDnDZVjsOtardLuwfIBg/800-600-image-jpeg-scale",
        )

    def test_local_media_thumbnail_dir(self) -> None:
        """Test local media thumbnail directory paths"""
        self.assertEqual(
            self.filepaths.local_media_thumbnail_sha_dir("GerZNDnDZVjsOtardLuwfIBg"),
            "/media_store/thumbnails/Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )

    def test_remote_media_filepath(self) -> None:
        """Test remote media paths"""
        self.assertEqual(
            self.filepaths.remote_media_filepath_sha_rel("GerZNDnDZVjsOtardLuwfIBg"),
            "Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )
        self.assertEqual(
            self.filepaths.remote_media_filepath_sha("GerZNDnDZVjsOtardLuwfIBg"),
            "/media_store/Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )
    ...
    def test_remote_media_thumbnail(self) -> None:
        ...
        self.assertEqual(
            self.filepaths.remote_media_thumbnail_sha_rel(
            ...
            "thumbnail/Ge/rZ/NDnDZVjsOtardLuwfIBg/800-600-image-jpeg-scale",
        )
        self.assertEqual(
            self.filepaths.remote_media_thumbnail_sha(
                "GerZNDnDZVjsOtardLuwfIBg",
                800,
                600,
                "image/jpeg",
            ...
            "/media_store/thumbnail/Ge/rZ/NDnDZVjsOtardLuwfIBg/800-600-image-jpeg-scale",
        )

    def test_remote_media_thumbnail_dir(self) -> None:
        """Test remote media thumbnail directory paths"""
        self.assertEqual(
            self.filepaths.remote_media_thumbnail_sha_dir("GerZNDnDZVjsOtardLuwfIBg"),
            "/media_store/thumbnail/Ge/rZ/NDnDZVjsOtardLuwfIBg",
        )
    ...
    def _test_path_validation(
        ...
        for method in methods:
            ...
            kwargs = {
                "sha256": "GerZNDnDZVjsOtardLuwfIBg",
...
class MediaStorageWithSHA256(unittest.HomeserverTestCase):
    servlets = [
    ...
    def prepare(self, reactor: MemoryReactor, clock: Clock, hs: HomeServer) -> None:
        ...
        self.media_root = self.hs.config.media.media_store_path
    ...
    def test_creating_media_with_sha256_path(self) -> None:
        assert isinstance(self.media_repository, MediaRepository)
        ...
        file_path = self.media_root + self.generate_path_from_media_id(SMALL_PNG_SHA256)

        assert os.path.getsize(file_path) == 67
