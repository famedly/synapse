...
See the folder [system](https://github.com/famedly/synapse/tree/master/docs/systemd-with-workers/system/)
for the systemd unit files.

The folder [workers](https://github.com/famedly/synapse/tree/master/docs/systemd-with-workers/workers/)
...
1. Copy the `*.service` and `*.target` files in [system](https://github.com/famedly/synapse/tree/master/docs/systemd-with-workers/system/)
...
[contrib/systemd/override-hardened.conf](https://github.com/famedly/synapse/tree/master/contrib/systemd/)
