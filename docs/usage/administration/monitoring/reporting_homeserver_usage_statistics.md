...
| `r30v2_users_unknown_android` | int    | The number of 30 day retained users, as defined above. Filtered only to clients with "android" but neither Element/Riot nor Famedly (case-insensitive) in the user agent string.                                                                                                               |
| `r30v2_users_unknown_ios`     | int    | The number of 30 day retained users, as defined above. Filtered only to clients with "ios" but neither Element/Riot nor Famedly (case-insensitive) in the user agent string.                                                                                                                   |
