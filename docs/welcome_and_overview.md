...
Welcome to the documentation repository for Famedly Synapse, a
[Matrix](https://matrix.org) homeserver implementation. This is Famedly's fork of Element Synapse.
...
* Read the [Contributing Guide](development/contributing_guide.md). It is meant
  ...
  GitHub](https://github.com/famedly/synapse)).
...
* Look at [the issue tracker](https://github.com/famedly/synapse/issues) for
  bugs to fix or features to add. If you're new, it may be best to start with
  those labeled [good first
  issue](https://github.com/famedly/synapse/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
...
* And finally, contribute to this documentation! The source for which is
  [located here](https://github.com/famedly/synapse/tree/master/docs).
