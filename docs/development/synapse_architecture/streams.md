...
Synapse has a concept of "streams", which are roughly described in [`id_generators.py`](
    https://github.com/famedly/synapse/blob/master/synapse/storage/util/id_generators.py
).
...
See [`synapse.replication.tcp.streams`](
    https://github.com/famedly/synapse/blob/master/synapse/replication/tcp/streams/__init__.py
...
To that end, let's describe streams formally, paraphrasing from the docstring of [`AbstractStreamIdGenerator`](
    https://github.com/famedly/synapse/blob/a719b703d9bd0dade2565ddcad0e2f3a7a9d4c37/synapse/storage/util/id_generators.py#L96
).
