...
class EventCreationHandler:
    ...
    async def _rebuild_event_after_third_party_rules(
        ...
        try:
            ...
            # The room_id should only be None in the case of a room version "12"(or
            # newer) room and if this is a creation event
            if not (
                builder.room_version.msc4291_room_ids_as_hashes
                and builder.type == EventTypes.Create
            ):
        ...
        # Creation events in room version "12" rooms will not have a room_id, and will
